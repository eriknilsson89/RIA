  ...
  'Backbone'    // lib/backbone/backbone
    ...
    TodoListViewEntry = Backbone.View.extend({
        ...
        edit: function (e) {
            ...
            this.removespan = this.el.childNodes[5];
            this.editspan = this.el.childNodes[6];
            this.donespan = this.el.childNodes[7];
