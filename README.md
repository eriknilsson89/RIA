...
Views/tagList.js - Skapar delen som hanterar taggar. Innehåller två templates, ett formulär som ska innehåla inputs med alla taggar som finns och en template som har ett input-fält och en submit.
